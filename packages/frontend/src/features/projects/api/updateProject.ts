...
import { ProjectSchema, type PatchProjectRequest, type Project } from "@pkg/shared";
import type { UpdateProjectResult } from "./types";

export const updateProject = async (project: PatchProjectRequest, id: Project["id"]): Promise<UpdateProjectResult> => {
